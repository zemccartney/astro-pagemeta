...
- **Ephemeris plugin overhead is ~${fmt(medianAuto.median - medianBaseline.median)}ms** on a median-sized (p50) page. Nearly all cost is rehype's HTML parse/serialize.
