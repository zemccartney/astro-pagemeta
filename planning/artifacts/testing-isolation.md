...
_Astro 7 re-measure 2026-07-12 (isolate:false + threads + maxWorkers 3): full suite ~14-18s wall under astro 7.0.6 vs ~21s under 6.4.8 with identical settings — Rolldown/Vite 8 claws back a chunk of the Astro 6 per-op regression. No socket errors observed across the upgrade runs._
